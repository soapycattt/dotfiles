...
find_west() {
	closest_west_window_id=$(yabai -m query --windows | jq -r\
    --argjson current_window_id $current_window_id\
    --argjson current_x $current_x\
...
find_east() {
	closest_east_window_id=$(yabai -m query --windows | jq -r\
    --argjson current_window_id $current_window_id\
    --argjson current_x_east $current_x_east\
    --argjson current_space $current_space\
    '[.[]
      | select(
          .id != $current_window_id and
...
find_north() {
	closest_north_window_id=$(yabai -m query --windows | jq -r\
    --argjson current_window_id $current_window_id\
    --argjson current_y $current_y\
    --argjson current_space $current_space\
    '[.[]
      | select(
          .id != $current_window_id and
...
find_south() {
	closest_south_window_id=$(yabai -m query --windows | jq -r\
    --argjson current_window_id $current_window_id\
    --argjson current_y_south $current_y_south\
    --argjson current_space $current_space\
    '[.[]
      | select(
          .id != $current_window_id and
